...
/**
 * Servlet implementation class ModifyPersonnel
 */
@WebServlet("/ModifyPersonnel")
public class ModifyPersonnel extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ModifyPersonnel() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		String personID = request.getParameter("spersonID");
		...
		PersonInfo4 pd = new PersonInfo4(id,personID, certificateID,certificateNumber, name,
		...
		if(pis.modify(pd)) {
			...
			request.setAttribute("flag", "修改完成");
